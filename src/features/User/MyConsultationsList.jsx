...
import { useMyConsultations } from "./useMyConsultations";
import { FiEye, FiSearch, FiFileText, FiClock, FiCheckCircle } from "react-icons/fi";
import Pagination from "../../ui/Pagination";

export default function MyConsultationsList() {
  const navigate = useNavigate();
  const { consultations: allConsultations, isLoading, error } = useMyConsultations();
  ...
  const metrics = useMemo(() => {
    ...
    return { total, pending, completed, scheduled };
  }, [allConsultations]);
    ...
    <VStack w="full" align="start" gap="30px">
      ...
      <VStack w="full" align="start" gap="8px">
        ...
        <Text fontSize="16px" color="brand.200" fontWeight={400}>
          View and track all your consultation requests.
        </Text>
      </VStack>
      ...
      <Box w="full" bg="white" rounded="16px" p="24px" border="1px solid" borderColor="#E5E7EB">
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing="16px" w="full">
          <InputGroup>
            ...
            <Input
              placeholder="Search by practice area, category..."
              value={searchQuery}
              ...
              <Tbody>
                {paginatedConsultations.map((consultation) => (
                  ...
                  >
                    ...
                    <Td py="16px" px="16px">
                      <Badge colorScheme={getStatusColor(consultation.status)} fontSize="12px" px="8px" py="4px">
